...
# INPUT DATA SET
# ==============
input_data_set = pd.read_csv('input_data_set.csv',#on doit changer le fichier en fonction de ce que l'on veut montrer
                             index_col=0,
                             parse_dates=True)
input_data_set
...
fig.tight_layout()
fig.savefig("Inital_simulation.svg",dpi=300)